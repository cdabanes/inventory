...
<div class="sub-content-container">
	<div class="w90 center">
		...
		?>
		<table class="table table table-striped table-bordered  table-condensed RECORD tablesorter canvasTable advancedTable" id="<?php echo $canvasTable; ?>" model="<?php echo $modelClass; ?>">
			<thead>
				<tr>
...
<!-- CANVASFORM -->
<?php 
echo "<?php echo \$this->Form->create('{$modelClass}',array('action'=>'index.json',
															'class'=>'canvasForm',
															'id'=>'{$canvasForm}',
															'model'=> '{$modelClass}',
															'canvas'=>'#{$canvasTable}'
