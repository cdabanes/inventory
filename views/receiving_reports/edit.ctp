...
<div class="row-fluid">
<div class="receivingReports form span6 offset3">

<?php echo $this->Form->create('ReceivingReport',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Edit Receiving Report'); ?></legend>
