				...
				<div class="row-fluid">
					<div class="span4 module">
						<div class="module-wrap">
							<div class="module-name articles">
...
<div class="sub-content-container">
	<div class="w80 center">
		<table class="table table table-striped table-bordered  table-condensed RECORD tablesorter canvasTable advancedTable" id="ArticleTable" model="Article">
			<thead>
				<tr>
					<th class="w50 text-center"><a >Name</a></th>
					<th class="w45 text-center"><a >Alias</a></th>
			...
			<tbody>
				<tr>
					...
					<td><span data-field='Article.alias'></span></td>
					<td class="actions">
						<div class="btn-group">
							<div class="btn-group btn-center">
								<button class="btn dropdown-toggle" data-toggle="dropdown"><i class="icon-cog"></i><span class="caret"></span></button>
								<ul class="dropdown-menu pull-right">
									<li><a href="#intent-modal" data-toggle="modal"  class="action-view"><i class="icon-eye-open"></i> Article Details</a></li>
...
<?php echo $this->Form->create('Article',array('name'=>'modalForm','action'=>'add','class'=>'form-horizontal', 'model'=> 'articles', 'canvas'=>'#ArticleCanvasForm',
...
<div id="intent-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="intent-label" aria-hidden="true">
	<div class="modal-header">
		<h3 id="intent-label"><span class="intent-text">Create </span><span class="intent-object">Article</span></h3>
	</div>
	<div class="modal-body">
		<div class="row-fluid">
			<div class="articles form span12">
...
<!-- CANVASFORM -->
<?php echo $this->Form->create('Article',array('action'=>'index.json',
															'class'=>'canvasForm',
															'id'=>'ArticleCanvasForm',
															'model'=> 'Article',
															'canvas'=>'#ArticleTable'
														)
											);?>
<?php echo $this->Form->end();?>
	...
	<?php echo $this->Form->create('Item',array('name'=>'ItemModal','action'=>'add','class'=>'form-horizontal', 'model'=> 'items', 'canvas'=>'#ItemCanvasForm',
																	'inputDefaults' => array( 	'label'=>array('class'=>'control-label'),
																								'div'=>array('class'=>'control-group')
																							)
																	)
		...
		<div id="items-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="intent-label" aria-hidden="true">
			<div class="modal-header">
...
<?php $this->Form->input('article_id',array('type'=>'hidden','value'=>null,'role'=>'foreign-key')); ?>
<?php echo $this->Form->end();?>
