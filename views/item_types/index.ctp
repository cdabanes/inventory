...
<div class="sub-content-container">
	<div class="w80 center">
		<table class="table table table-striped table-bordered  table-condensed RECORD tablesorter canvasTable advancedTable" id="ItemTypeTable" model="ItemType">
			<thead>
				<tr>
					<th class="w40 text-center"><a >Name</a></th>
			...
			<tbody>
				<tr>
					...
					<td><span data-field='ItemType.alias'></span></td>
					<td class="actions">
						<div class="btn-group">
							<div class="btn-group btn-center">
								<button class="btn dropdown-toggle" data-toggle="dropdown"><i class="icon-cog"></i><span class="caret"></span></button>
								<ul class="dropdown-menu pull-right">	
									<li><a href="#intent-modal" data-toggle="modal"  class="action-view view-items"><i class="icon-eye-open"></i> Items</a></li>									 
...
<?php echo $this->Form->create('ItemType',array('name'=>'modalForm','action'=>'add','class'=>'form-horizontal', 'model'=> 'itemTypes', 'canvas'=>'#ItemTypeCanvasForm',
...
<div id="intent-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="intent-label" aria-hidden="true">
	<div class="modal-header">
		<h3 id="intent-label"><span class="intent-text">Create </span><span class="intent-object">Item Type</span></h3>
	</div>
	<div class="modal-body">
		<div class="row-fluid">
			<div class="itemTypes form span12">
...
<!-- CANVASFORM -->
<?php echo $this->Form->create('ItemType',array('action'=>'index.json',
															'class'=>'canvasForm',
															'id'=>'ItemTypeCanvasForm',
															'model'=> 'ItemType',
															'canvas'=>'#ItemTypeTable'
														)
											);?>
<?php echo $this->Form->end();?>
